...
<script type="text/javascript" src="${pageContext.request.contextPath }/static/customer/js/modernizr-2.6.2.min.js"></script>
  ...
  <body>
	...
	<!-- end:fh5co-header -->
	<div class="fh5co-parallax" style="background-image: url(${pageContext.request.contextPath}/static/customer/images/slider3.jpg);" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
					<div class="fh5co-intro fh5co-table-cell">
						<h1 class="text-center">阅读我们的博客</h1>
	...
	<div id="fh5co-blog-section">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<div class="blog-grid" style="background-image: url(${pageContext.request.contextPath}/static/customer/images/image-1.jpg);">
					...
					<div class="desc">
						<h3><a href="javaScript:;">听说一种深海珍宝游到了彩蝶谷</a></h3>
					</div>
				</div>
				<div class="col-md-4">
					<div class="blog-grid" style="background-image: url(${pageContext.request.contextPath}/static/customer/images/image-2.jpg);">
						<div class="date text-center">
							<span>05</span>
							<small>Aug</small>
						</div>
					...
					<div class="desc">
						<h3><a href="javaScript:;">婚宴——定格幸福瞬间</a></h3>
					</div>
				</div>
				<div class="col-md-4">
					<div class="blog-grid" style="background-image: url(${pageContext.request.contextPath}/static/customer/images/image-3.jpg);">
						<div class="date text-center">
							<span>06</span>
							<small>Aug</small>
						</div>
					...
					<div class="desc">
						<h3><a href="javaScript:;">会议——打造各种非同凡响</a></h3>
					</div>
				</div>
				<div class="col-md-4">
					<div class="blog-grid" style="background-image: url(${pageContext.request.contextPath}/static/customer/images/image-4.jpg);">
						<div class="date text-center">
							<span>07</span>
							<small>Aug</small>
						</div>
					...
					<div class="desc">
						<h3><a href="javaScript:;">任凭刮风下雨，也不能阻碍我的欢</a></h3>
					</div>
				</div>
				<div class="col-md-4">
					<div class="blog-grid" style="background-image: url(${pageContext.request.contextPath}/static/customer/images/image-5.jpg);">
						<div class="date text-center">
							<span>08</span>
							<small>Aug</small>
						</div>
					...
					<div class="desc">
						<h3><a href="javaScript:;">七夕蟹逅，浓情蜜意</a></h3>
					</div>
				</div>
				<div class="col-md-4">
					<div class="blog-grid" style="background-image: url(${pageContext.request.contextPath}/static/customer/images/image-6.jpg);">
						<div class="date text-center">
							<span>09</span>
							<small>Aug</small>
						</div>
					...
					<div class="desc">
						<h3><a href="javaScript:;">月圆 心圆 人团圆 “浓情家圆”中秋晚</a></h3>
					</div>
				</div>
			</div>
		</div>
